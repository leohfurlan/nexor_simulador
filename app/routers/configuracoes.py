...
def _display(params) -> dict:
    ...
    valores = {campo: float(getattr(params, campo)) * 100 for campo in ALIQUOTA_FIELDS}
    valores.update({campo: float(getattr(params, campo)) for campo in HONORARIO_FIELDS})
    return valores
    ...
    try:
        params = await update_parametros(
            ...
            aliquotas_pct={
                ...
                "aliquota_lucro_presumido_ibs_cbs": aliquota_lucro_presumido_ibs_cbs,
                "aliquota_lucro_real_irpj_csll": aliquota_lucro_real_irpj_csll,
            ...
            honorarios={
                ...
                "honorario_lucro_real": honorario_lucro_real,
            },
        )
